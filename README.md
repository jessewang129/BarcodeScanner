...
Scans barcode to show product info and allows the user to view/add descriptions of the product. Our original plan is to make a forum like environment where people can comment on the information regarding recycling for each product as long as they have access to the bardcode. However with time restraint and the absence of two original members we could only implement a very basic function so far.
